...
const About = () => {
  return (
    <div className="container mx-auto mb-10">
      <div className="mx-5 flex flex-col lg:flex-row items-center md:mx-0">
        <div className="lg:w-6/12 p-2">
          <h1 className="text-5xl font-medium text-white mt-10">Hamid Ali</h1>
        ...
        <div className="lg:w-6/12">
          <img className="w-full p-2 rounded-md" src={aboutPhoto} alt="" />
        </div>
      </div>
    </div>
  );
